...
function GainerLoser(props) {

    const [rowData, setRowData] = useState()
       function fetchData(){
        fetch("https://financialmodelingprep.com/api/v3/stock_market/gainers?apikey=9f8bf374d13311bf6527af0ea58ebdb6")
          .then(res => res.json())
          .then(
            (result) => {
              ...
              <div className ="col-md-6">
                  <div className ="card py-3 px-3">
                        <div className = 'pt-3 pb-2 py-2 px-2  '>
                            <h3 style = {{marginBottom:'3px'}}>BIGGEST GAINERS</h3>
